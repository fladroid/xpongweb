...
(function () {
  ...
  var NAV = [
    ...
    { id: 'rl2',       href: 'rl2.html',       key: 'nav_rl2' },
  ...
  var T = {
    en: {
      ...
      x_title: 'Telemetry',
      x_intro: 'The beam shows where the ball is going by pure physics \u2014 up to the first wall, paddle or goal. It stops where certainty ends: it never predicts the bounce or anyone\u2019s move. Toggle it with the Beam switch or the x key. Built in the X-Ray attitude \u2014 see About.',
      x_heat_box_title: 'Heatmap',
      x_heat_box_text: 'The heatmap is a shadow, not a mind: it records only where the ball has physically crossed each goal line. Thin frames mark the bands on each wall; a band grows darker the more goals have landed in it. Counts accumulate through the session \u2014 Reset clears them. Toggle it with the Heatmap switch or the h key.',
      x_nav_title: 'Navigation',
      x_nav_text: 'Left player: W up, S down. Right player: O up, L down. On a touch device, drag on your own half of the field to move your paddle.',
      r1_title: 'RL 1 — Random walker',
      r2_title: 'RL 2 — How the agent sees the world',
      r2_grid_label: 'State space',
      r2_grid_coarse: 'Coarse',
      ...
      r2_page_title: 'State space',
      r2_results_title: 'Reading the results',
      r2_results_text: 'Press Train: it runs 12,000 episodes in the background, and every 500 episodes it pauses to play one evaluation match <em>live</em> — the agent’s actual policy at that point, no exploration. The chart plots average returns per evaluation episode; the current run stays dark, earlier runs fade to grey. Train again after a run finishes to add a new curve — the <em>spread</em> between curves is the reliability of the result, not the height of any single line alone. Reset clears everything and starts over.',
      r2_page_text: 'This is the first RL page with an agent that <strong>learns</strong>. The subject here is not learning itself but what the agent can <em>see</em>: the world reduced to a finite set of bins. The grid draws two of the five dimensions — where the ball is. Direction, speed, and the paddle’s own position also enter the state number but have no place on the court. Coarse, medium, and fine give the agent a coarser or finer view of the same world.',
      r2_legend_left_agent: 'Learning agent',
      r2_chart_title: 'Evaluation quality across training',
      r2_chart_caption: 'X axis: training episode, 0 to 12,000. Y axis: average returns per evaluation — the same number as "returns / episode" below.',
      r2_status_idle: 'Press Train to begin',
      r2_status_training: 'Training…',
      r2_status_watching: 'Watching the agent play',
      r2_status_done: 'Training complete',
      r1_page_title: 'This page — RL 1',
      r1_page_text: 'The first RL page. The right paddle is an <strong>agent that plays but does not learn</strong> — a <em>random walker</em>, the zero-baseline of reinforcement learning: each step it moves up, stays, or moves down at random, with no memory and no goal. Use the switch to make the left paddle a human (W/S) or a second agent. The Beam and Heatmap below read the <em>world</em> — the ball\'s path and past goals — not the agent\'s mind: there is no mind here yet to X-ray. A learning agent, and the telemetry of its decisions, arrives on the next page.',
      r1_nav_text: 'Left player (human mode): W up, S down, or drag on the left half on touch. The right player is the agent. Flip the left paddle to an agent with the switch by the controls.',
      r1_mode_human: 'Left: Human',
      r1_mode_agent: 'Left: Agent',
      x_box_title: 'Beam',
      x_ray_on: 'Beam: on',
      x_ray_off: 'Beam: off',
      x_heat_on: 'Heatmap: on',
      x_heat_off: 'Heatmap: off',
    ...
    de: {
      ...
      x_title: 'Telemetrie',
      x_intro: 'Der Strahl zeigt durch reine Physik, wohin der Ball fliegt \u2014 bis zur ersten Wand, zum ersten Schl\u00e4ger oder Tor. Er endet dort, wo die Gewissheit endet: Er sagt niemals den Abprall oder den Zug eines Spielers voraus. Ein-/ausschalten mit dem Strahl-Schalter oder der Taste x. Gebaut in der X-Ray-Haltung \u2014 siehe \xdcber.',
      x_heat_box_title: 'Heatmap',
      x_heat_box_text: 'Die Heatmap ist ein Schatten, kein Verstand: Sie zeichnet nur auf, wo der Ball die Torlinie physisch \xfcberquert hat. D\xfcnne Rahmen markieren die Zonen an jeder Wand; eine Zone wird dunkler, je mehr Tore dort gefallen sind. Die Z\xe4hlung l\xe4uft \xfcber die Sitzung \u2014 Reset l\xf6scht sie. Ein-/ausschalten mit dem Heatmap-Schalter oder der Taste h.',
      x_nav_title: 'Navigation',
      x_nav_text: 'Spieler links: W hoch, S runter. Spieler rechts: O hoch, L runter. Auf einem Touchger\xe4t: Wische auf deiner eigenen H\xe4lfte des Feldes, um deinen Schl\xe4ger zu bewegen.',
      r1_title: 'RL 1 \u2014 Random Walker',
      r2_title: 'RL 2 \u2014 Wie der Agent die Welt sieht',
      r2_grid_label: 'Zustandsraum',
      r2_grid_coarse: 'Grob',
      ...
      r2_page_title: 'Zustandsraum',
      r2_results_title: 'Die Ergebnisse lesen',
      r2_results_text: 'Train drücken: Es laufen 12.000 Episoden im Hintergrund, und alle 500 Episoden pausiert es, um eine Bewertungspartie <em>live</em> zu spielen — die tatsächliche Politik des Agenten an diesem Punkt, ohne Exploration. Die Kurve zeigt die durchschnittliche Rückgabe pro Bewertungsepisode; der aktuelle Lauf bleibt dunkel, frühere Läufe verblassen zu Grau. Nach Abschluss eines Laufs erneut Train drücken, um eine neue Kurve hinzuzufügen — die <em>Streuung</em> zwischen den Kurven ist die Verlässlichkeit des Ergebnisses, nicht die Höhe einer einzelnen Linie allein. Reset löscht alles und beginnt neu.',
      r2_page_text: 'Dies ist die erste RL-Seite mit einem Agenten, der <strong>lernt</strong>. Das Thema ist nicht das Lernen selbst, sondern was der Agent <em>sieht</em>: die Welt, reduziert auf endlich viele Fächer. Das Raster zeichnet zwei der fünf Dimensionen — wo der Ball ist. Richtung, Geschwindigkeit und die eigene Schlägerposition gehen ebenfalls in die Zustandszahl ein, haben aber keinen Ort auf dem Feld. Grob, mittel und fein geben dem Agenten eine gröbere oder feinere Sicht auf dieselbe Welt.',
      r2_legend_left_agent: 'Lernender Agent',
      r2_chart_title: 'Bewertungsqualität über das Training',
      r2_chart_caption: 'X-Achse: Trainingsepisode, 0 bis 12.000. Y-Achse: durchschnittliche Abwehr pro Bewertungsepisode — dieselbe Zahl wie „Abwehr / Episode“ unten.',
      r2_status_idle: 'Drücke Train, um zu beginnen',
      r2_status_training: 'Wird trainiert…',
      r2_status_watching: 'Der Agent spielt gerade',
      r2_status_done: 'Training abgeschlossen',
      r1_page_title: 'Diese Seite \u2014 RL 1',
      r1_page_text: 'Die erste RL-Seite. Der rechte Schl\xe4ger ist ein <strong>Agent, der spielt, aber nicht lernt</strong> \u2014 ein <em>Random Walker</em>, die Nulllinie des Reinforcement Learning: bei jedem Schritt bewegt er sich zuf\xe4llig nach oben, bleibt stehen oder bewegt sich nach unten, ohne Ged\xe4chtnis und ohne Ziel. Mit dem Schalter machst du den linken Schl\xe4ger zu einem Menschen (W/S) oder zu einem zweiten Agenten. Beam und Heatmap unten lesen die <em>Welt</em> \u2014 die Bahn des Balls und vergangene Tore \u2014 nicht den Geist des Agenten: hier gibt es noch keinen Geist zum Durchleuchten. Ein lernender Agent und die Telemetrie seiner Entscheidungen kommen auf der n\xe4chsten Seite.',
      r1_nav_text: 'Spieler links (Menschmodus): W hoch, S runter, oder auf dem Touchscreen die linke H\xe4lfte ziehen. Der rechte Spieler ist der Agent. Mit dem Schalter bei den Steuerungen wird der linke Schl\xe4ger zum Agenten.',
      r1_mode_human: 'Links: Mensch',
      r1_mode_agent: 'Links: Agent',
      x_box_title: 'Strahl',
      x_ray_on: 'Strahl: an',
      x_ray_off: 'Strahl: aus',
      x_heat_on: 'Heatmap: an',
      x_heat_off: 'Heatmap: aus',
    ...
    it: {
      ...
      x_title: 'Telemetria',
      x_intro: 'Il raggio mostra, per pura fisica, dove va la palla \u2014 fino al primo muro, racchetta o porta. Si ferma dove finisce la certezza: non predice mai il rimbalzo n\u00e9 la mossa di nessuno. Attivalo o disattivalo con l\u2019interruttore Raggio o il tasto x. Costruito con l\u2019atteggiamento X-Ray \u2014 vedi Info.',
      x_heat_box_title: 'Heatmap',
      x_heat_box_text: 'La heatmap \xe8 un\u2019ombra, non una mente: registra solo dove la palla ha fisicamente attraversato la linea di porta. Cornici sottili segnano le fasce su ogni parete; una fascia si scurisce quanto pi\xf9 gol vi sono caduti. I conteggi si accumulano durante la sessione \u2014 Reset li azzera. Attivala o disattivala con l\u2019interruttore Heatmap o il tasto h.',
      x_nav_title: 'Navigazione',
      x_nav_text: 'Giocatore sinistro: W su, S gi\xf9. Giocatore destro: O su, L gi\xf9. Su un dispositivo touch, trascina sulla tua met\xe0 del campo per muovere la racchetta.',
      r1_title: 'RL 1 \u2014 Random walker',
      r2_title: 'RL 2 \u2014 Come l\u2019agente vede il mondo',
      r2_grid_label: 'Spazio degli stati',
      r2_grid_coarse: 'Grossolana',
      ...
      r2_page_title: 'Spazio degli stati',
      r2_results_title: 'Leggere i risultati',
      r2_results_text: 'Premi Train: esegue 12.000 episodi in background e, ogni 500 episodi, si ferma per giocare una partita di valutazione <em>dal vivo</em> — la politica reale dell’agente in quel momento, senza esplorazione. Il grafico traccia le respinte medie per episodio di valutazione; l’esecuzione attuale resta scura, quelle precedenti sfumano in grigio. Premi di nuovo Train dopo che un’esecuzione finisce per aggiungere una nuova curva — la <em>dispersione</em> tra le curve è l’affidabilità del risultato, non l’altezza di una singola linea da sola. Reset azzera tutto e ricomincia.',
      r2_page_text: 'Questa è la prima pagina RL con un agente che <strong>impara</strong>. Il tema non è l’apprendimento in sé ma ciò che l’agente <em>vede</em>: il mondo ridotto a un numero finito di caselle. La griglia disegna due delle cinque dimensioni — dove si trova la palla. Direzione, velocità e la posizione della racchetta entrano anch’esse nel numero di stato ma non hanno posto sul campo. Grossolana, media e fine danno all’agente una vista più o meno dettagliata dello stesso mondo.',
      r2_legend_left_agent: 'Agente che impara',
      r2_chart_title: 'Qualità di valutazione durante l’addestramento',
      r2_chart_caption: 'Asse X: episodio di addestramento, da 0 a 12.000. Asse Y: respinte medie per valutazione — lo stesso numero di "respinte / episodio" sotto.',
      r2_status_idle: 'Premi Train per iniziare',
      r2_status_training: 'Addestramento…',
      r2_status_watching: 'L’agente sta giocando',
      r2_status_done: 'Addestramento completato',
      r1_page_title: 'Questa pagina \u2014 RL 1',
      r1_page_text: 'La prima pagina RL. La racchetta destra \xe8 un <strong>agente che gioca ma non impara</strong> \u2014 un <em>random walker</em>, la linea zero del reinforcement learning: a ogni passo si muove su, resta fermo o si muove gi\xf9 a caso, senza memoria e senza obiettivo. Usa l\'interruttore per rendere la racchetta sinistra un umano (W/S) o un secondo agente. Beam e Heatmap qui sotto leggono il <em>mondo</em> \u2014 la traiettoria della palla e i gol passati \u2014 non la mente dell\'agente: qui non c\'\xe8 ancora nessuna mente da radiografare. Un agente che impara, e la telemetria delle sue decisioni, arriva nella pagina successiva.',
      r1_nav_text: 'Giocatore sinistro (modalit\xe0 umana): W su, S gi\xf9, o trascina sulla met\xe0 sinistra su touch. Il giocatore destro \xe8 l\'agente. Con l\'interruttore vicino ai comandi la racchetta sinistra diventa un agente.',
      r1_mode_human: 'Sinistra: umano',
      r1_mode_agent: 'Sinistra: agente',
      x_box_title: 'Raggio',
      x_ray_on: 'Raggio: attivo',
      x_ray_off: 'Raggio: spento',
      x_heat_on: 'Heatmap: attiva',
      x_heat_off: 'Heatmap: spenta',
    ...
    hr: {
      ...
      x_title: 'Telemetrija',
      x_intro: 'Zraka pokazuje, \u010distom fizikom, kamo lopta ide \u2014 do prvog zida, reketa ili gola. Staje ondje gdje prestaje izvjesnost: nikada ne predvi\u0111a odboj ni ne\u010diji potez. Uklju\u010di je i isklju\u010di prekida\u010dem Zraka ili tipkom x. Gra\u0111eno u X-Ray stavu \u2014 vidi O projektu.',
      x_heat_box_title: 'Heatmap',
      x_heat_box_text: 'Heatmap je sjena, ne um: bilje\u017ei samo gdje je lopta fizi\u010dki pre\u0161la gol-liniju. Tanki okviri ozna\u010davaju trake na svakom zidu; traka postaje tamnija \u0161to je vi\u0161e golova palo u nju. Broja\u010di se skupljaju kroz sesiju \u2014 Reset ih bri\u0161e. Uklju\u010di ga i isklju\u010di prekida\u010dem Heatmap ili tipkom h.',
      x_nav_title: 'Navigacija',
      x_nav_text: 'Lijevi igra\u010d: W gore, S dolje. Desni igra\u010d: O gore, L dolje. Na dodirnom ure\u0111aju povuci po svojoj polovini terena da pomakne\u0161 reket.',
      r1_title: 'RL 1 \u2014 Nasumi\u010dni \u0161eta\u010d',
      r2_title: 'RL 2 \u2014 Kako agent vidi svijet',
      r2_grid_label: 'Prostor stanja',
      r2_grid_coarse: 'Gruba',
      ...
      r2_page_title: 'Prostor stanja',
      r2_results_title: 'Čitanje rezultata',
      r2_results_text: 'Pritisni Train: izvodi 12.000 epizoda u pozadini i svakih 500 epizoda zastane da odigra jednu evaluacijsku partiju <em>uživo</em> — stvarnu politiku agenta u tom trenutku, bez istraživanja. Grafikon crta prosječna odbijanja po evaluacijskoj epizodi; trenutno pokretanje ostaje tamno, ranija pokretanja blijede u sivo. Pritisni Train ponovo nakon što se pokretanje završi da dodaš novu krivulju — <em>raspršenost</em> među krivuljama je pouzdanost rezultata, ne visina jedne linije same. Reset briše sve i počinje ispočetka.',
      r2_page_text: 'Ovo je prva RL stranica s agentom koji <strong>uči</strong>. Tema nije samo učenje nego ono što agent <em>vidi</em>: svijet sveden na konačan broj pregrada. Mreža crta dvije od pet dimenzija — gdje je loptica. Smjer, brzina i položaj vlastitog reketa također ulaze u broj stanja, ali nemaju mjesto na terenu. Gruba, srednja i fina daju agentu grublji ili finiji pogled na isti svijet.',
      r2_legend_left_agent: 'Agent koji uči',
      r2_chart_title: 'Kvaliteta procjene tijekom treninga',
      r2_chart_caption: 'X os: epizoda treninga, 0 do 12.000. Y os: prosječna odbijanja po procjeni — isti broj kao "odbijanja / epizoda" ispod.',
      r2_status_idle: 'Pritisni Train za početak',
      r2_status_training: 'Treniranje…',
      r2_status_watching: 'Agent upravo igra',
      r2_status_done: 'Trening završen',
      r1_page_title: 'Ova stranica \u2014 RL 1',
      r1_page_text: 'Prva RL stranica. Desni reket je <strong>agent koji igra ali ne u\u010di</strong> \u2014 <em>nasumi\u010dni \u0161eta\u010d</em>, nulta osnovica reinforcement learninga: pri svakom koraku nasumi\u010dno se pomi\u010de gore, miruje ili se pomi\u010de dolje, bez pam\u0107enja i bez cilja. Prekida\u010dem lijevi reket pretvara\u0161 u \u010dovjeka (W/S) ili u drugog agenta. Beam i Heatmap ispod \u010ditaju <em>svijet</em> \u2014 putanju loptice i pro\u0161le golove \u2014 ne um agenta: ovdje uma za rendgen jo\u0161 nema. Agent koji u\u010di, i telemetrija njegovih odluka, dolaze na sljede\u0107oj stranici.',
      r1_nav_text: 'Lijevi igra\u010d (ljudski na\u010din): W gore, S dolje, ili povuci po lijevoj polovici na dodir. Desni igra\u010d je agent. Prekida\u010dem kraj kontrola lijevi reket postaje agent.',
      r1_mode_human: 'Lijevo: \u010dovjek',
      r1_mode_agent: 'Lijevo: agent',
      x_box_title: 'Zraka',
      x_ray_on: 'Zraka: uklju\u010dena',
      x_ray_off: 'Zraka: isklju\u010dena',
      x_heat_on: 'Heatmap: uključen',
      x_heat_off: 'Heatmap: isključen',
    ...
    sr: {
      cyr: {
        ...
        x_title: '\u0422\u0435\u043b\u0435\u043c\u0435\u0442\u0440\u0438\u0458\u0430',
        x_intro: '\u0417\u0440\u0430\u043a \u043f\u043e\u043a\u0430\u0437\u0443\u0458\u0435, \u0447\u0438\u0441\u0442\u043e\u043c \u0444\u0438\u0437\u0438\u043a\u043e\u043c, \u043a\u0443\u0434\u0430 \u043b\u043e\u043f\u0442\u0430 \u0438\u0434\u0435 \u2014 \u0434\u043e \u043f\u0440\u0432\u043e\u0433 \u0437\u0438\u0434\u0430, \u0440\u0435\u043a\u0435\u0442\u0430 \u0438\u043b\u0438 \u0433\u043e\u043b\u0430. \u0421\u0442\u0430\u0458\u0435 \u0442\u0430\u043c\u043e \u0433\u0434\u0435 \u043f\u0440\u0435\u0441\u0442\u0430\u0458\u0435 \u0438\u0437\u0432\u0435\u0441\u043d\u043e\u0441\u0442: \u043d\u0438\u043a\u0430\u0434\u0430 \u043d\u0435 \u043f\u0440\u0435\u0434\u0432\u0438\u0452\u0430 \u043e\u0434\u0431\u043e\u0458 \u043d\u0438 \u043d\u0435\u0447\u0438\u0458\u0438 \u043f\u043e\u0442\u0435\u0437. \u0423\u043a\u0459\u0443\u0447\u0438 \u0433\u0430 \u0438 \u0438\u0441\u043a\u0459\u0443\u0447\u0438 \u043f\u0440\u0435\u043a\u0438\u0434\u0430\u0447\u0435\u043c \u0417\u0440\u0430\u043a \u0438\u043b\u0438 \u0442\u0430\u0441\u0442\u0435\u0440\u043e\u043c x. \u0413\u0440\u0430\u0452\u0435\u043d\u043e \u0443 X-Ray \u0441\u0442\u0430\u0432\u0443 \u2014 \u0432\u0438\u0434\u0438 \u041e \u043f\u0440\u043e\u0458\u0435\u043a\u0442\u0443.',
        x_heat_box_title: 'Heatmap',
        x_heat_box_text: 'Heatmap \u0458\u0435 \u0441\u0435\u043d\u043a\u0430, \u043d\u0435 \u0443\u043c: \u0431\u0435\u043b\u0435\u0436\u0438 \u0441\u0430\u043c\u043e \u0433\u0434\u0435 \u0458\u0435 \u043b\u043e\u043f\u0442\u0430 \u0444\u0438\u0437\u0438\u0447\u043a\u0438 \u043f\u0440\u0435\u0448\u043b\u0430 \u0433\u043e\u043b-\u043b\u0438\u043d\u0438\u0458\u0443. \u0422\u0430\u043d\u043a\u0438 \u043e\u043a\u0432\u0438\u0440\u0438 \u043e\u0437\u043d\u0430\u0447\u0430\u0432\u0430\u0458\u0443 \u0442\u0440\u0430\u043a\u0435 \u043d\u0430 \u0441\u0432\u0430\u043a\u043e\u043c \u0437\u0438\u0434\u0443; \u0442\u0440\u0430\u043a\u0430 \u043f\u043e\u0441\u0442\u0430\u0458\u0435 \u0442\u0430\u043c\u043d\u0438\u0458\u0430 \u0448\u0442\u043e \u0458\u0435 \u0432\u0438\u0448\u0435 \u0433\u043e\u043b\u043e\u0432\u0430 \u043f\u0430\u043b\u043e \u0443 \u045a\u0443. \u0411\u0440\u043e\u0458\u0430\u0447\u0438 \u0441\u0435 \u0441\u043a\u0443\u043f\u0459\u0430\u0458\u0443 \u043a\u0440\u043e\u0437 \u0441\u0435\u0441\u0438\u0458\u0443 \u2014 Reset \u0438\u0445 \u0431\u0440\u0438\u0448\u0435. \u0423\u043a\u0459\u0443\u0447\u0438 \u0433\u0430 \u0438 \u0438\u0441\u043a\u0459\u0443\u0447\u0438 \u043f\u0440\u0435\u043a\u0438\u0434\u0430\u0447\u0435\u043c Heatmap \u0438\u043b\u0438 \u0442\u0430\u0441\u0442\u0435\u0440\u043e\u043c h.',
        x_nav_title: '\u041d\u0430\u0432\u0438\u0433\u0430\u0446\u0438\u0458\u0430',
        x_nav_text: '\u041b\u0435\u0432\u0438 \u0438\u0433\u0440\u0430\u0447: W \u0433\u043e\u0440\u0435, S \u0434\u043e\u043b\u0435. \u0414\u0435\u0441\u043d\u0438 \u0438\u0433\u0440\u0430\u0447: O \u0433\u043e\u0440\u0435, L \u0434\u043e\u043b\u0435. \u041d\u0430 \u0434\u043e\u0434\u0438\u0440\u043d\u043e\u043c \u0443\u0440\u0435\u0452\u0430\u0458\u0443 \u043f\u0440\u0435\u0432\u0443\u0446\u0438 \u043f\u043e \u0441\u0432\u043e\u0458\u043e\u0458 \u043f\u043e\u043b\u043e\u0432\u0438\u043d\u0438 \u0442\u0435\u0440\u0435\u043d\u0430 \u0434\u0430 \u043f\u043e\u043c\u0435\u0440\u0438\u0448 \u0440\u0435\u043a\u0435\u0442.',
        r1_title: '\u0420\u041b 1 \u2014 \u041d\u0430\u0441\u0443\u043c\u0438\u0447\u043d\u0438 \u0448\u0435\u0442\u0430\u0447',
        r2_title: '\u0420\u041b 2 \u2014 \u041a\u0430\u043a\u043e \u0430\u0433\u0435\u043d\u0442 \u0432\u0438\u0434\u0438 \u0441\u0432\u0435\u0442',
        r2_grid_label: '\u041f\u0440\u043e\u0441\u0442\u043e\u0440 \u0441\u0442\u0430\u045a\u0430',
        r2_grid_coarse: '\u0413\u0440\u0443\u0431\u0430',
        ...
        r2_page_title: 'Простор стања',
        r2_results_title: 'Читање резултата',
        r2_results_text: 'Притисни Train: изводи 12.000 епизода у позадини и сваких 500 епизода застане да одигра једну евалуациону партију <em>уживо</em> — стварну политику агента у том тренутку, без истраживања. Графикон црта просечна одбијања по евалуационој епизоди; тренутно покретање остаје тамно, ранија покретања бледе у сиво. Притисни Train поново након што се покретање заврши да додаш нову криву — <em>расподела</em> међу кривама је поузданост резултата, не висина једне линије саме. Reset брише све и почиње испочетка.',
        r2_page_text: 'Ово је прва RL страница са агентом који <strong>учи</strong>. Тема није само учење него оно што агент <em>види</em>: свет сведен на коначан број преграда. Мрежа црта две од пет димензија — где је лоптица. Смер, брзина и положај властитог рекета такође улазе у број стања, али немају место на терену. Груба, средња и фина дају агенту грубљи или финији поглед на исти свет.',
        r2_legend_left_agent: 'Агент који учи',
        r2_chart_title: 'Квалитет процене током тренинга',
        r2_chart_caption: 'X оса: епизода тренинга, 0 до 12.000. Y оса: просечна одбијања по процени — исти број као "одбијања / епизода" испод.',
        r2_status_idle: 'Притисни Train за почетак',
        r2_status_training: 'Тренирање…',
        r2_status_watching: 'Агент управо игра',
        r2_status_done: 'Тренинг завршен',
        r1_page_title: '\u041e\u0432\u0430 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u2014 \u0420\u041b 1',
        r1_page_text: '\u041f\u0440\u0432\u0430 \u0420\u041b \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0430. \u0414\u0435\u0441\u043d\u0438 \u0440\u0435\u043a\u0435\u0442 \u0458\u0435 <strong>\u0430\u0433\u0435\u043d\u0442 \u043a\u043e\u0458\u0438 \u0438\u0433\u0440\u0430 \u0430\u043b\u0438 \u043d\u0435 \u0443\u0447\u0438</strong> \u2014 <em>\u043d\u0430\u0441\u0443\u043c\u0438\u0447\u043d\u0438 \u0448\u0435\u0442\u0430\u0447</em>, \u043d\u0443\u043b\u0442\u0430 \u043e\u0441\u043d\u043e\u0432\u0438\u0446\u0430 reinforcement learning-\u0430: \u043f\u0440\u0438 \u0441\u0432\u0430\u043a\u043e\u043c \u043a\u043e\u0440\u0430\u043a\u0443 \u043d\u0430\u0441\u0443\u043c\u0438\u0447\u043d\u043e \u0441\u0435 \u043f\u043e\u043c\u0435\u0440\u0430 \u0433\u043e\u0440\u0435, \u043c\u0438\u0440\u0443\u0458\u0435 \u0438\u043b\u0438 \u0441\u0435 \u043f\u043e\u043c\u0435\u0440\u0430 \u0434\u043e\u043b\u0435, \u0431\u0435\u0437 \u043f\u0430\u043c\u045b\u0435\u045a\u0430 \u0438 \u0431\u0435\u0437 \u0446\u0438\u0459\u0430. \u041f\u0440\u0435\u043a\u0438\u0434\u0430\u0447\u0435\u043c \u043b\u0435\u0432\u0438 \u0440\u0435\u043a\u0435\u0442 \u043f\u0440\u0435\u0442\u0432\u0430\u0440\u0430\u0448 \u0443 \u0447\u043e\u0432\u0435\u043a\u0430 (W/S) \u0438\u043b\u0438 \u0443 \u0434\u0440\u0443\u0433\u043e\u0433 \u0430\u0433\u0435\u043d\u0442\u0430. Beam \u0438 Heatmap \u0438\u0441\u043f\u043e\u0434 \u0447\u0438\u0442\u0430\u0458\u0443 <em>\u0441\u0432\u0435\u0442</em> \u2014 \u043f\u0443\u0442\u0430\u045a\u0443 \u043b\u043e\u043f\u0442\u0438\u0446\u0435 \u0438 \u043f\u0440\u043e\u0448\u043b\u0435 \u0433\u043e\u043b\u043e\u0432\u0435 \u2014 \u043d\u0435 \u0443\u043c \u0430\u0433\u0435\u043d\u0442\u0430: \u043e\u0432\u0434\u0435 \u0443\u043c\u0430 \u0437\u0430 \u0440\u0435\u043d\u0434\u0433\u0435\u043d \u0458\u043e\u0448 \u043d\u0435\u043c\u0430. \u0410\u0433\u0435\u043d\u0442 \u043a\u043e\u0458\u0438 \u0443\u0447\u0438, \u0438 \u0442\u0435\u043b\u0435\u043c\u0435\u0442\u0440\u0438\u0458\u0430 \u045a\u0435\u0433\u043e\u0432\u0438\u0445 \u043e\u0434\u043b\u0443\u043a\u0430, \u0434\u043e\u043b\u0430\u0437\u0435 \u043d\u0430 \u0441\u043b\u0435\u0434\u0435\u045b\u043e\u0458 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0438.',
        r1_nav_text: '\u041b\u0435\u0432\u0438 \u0438\u0433\u0440\u0430\u0447 (\u0459\u0443\u0434\u0441\u043a\u0438 \u0440\u0435\u0436\u0438\u043c): W \u0433\u043e\u0440\u0435, S \u0434\u043e\u043b\u0435, \u0438\u043b\u0438 \u043f\u0440\u0435\u0432\u0443\u0446\u0438 \u043f\u043e \u043b\u0435\u0432\u043e\u0458 \u043f\u043e\u043b\u043e\u0432\u0438\u043d\u0438 \u043d\u0430 \u0434\u043e\u0434\u0438\u0440. \u0414\u0435\u0441\u043d\u0438 \u0438\u0433\u0440\u0430\u0447 \u0458\u0435 \u0430\u0433\u0435\u043d\u0442. \u041f\u0440\u0435\u043a\u0438\u0434\u0430\u0447\u0435\u043c \u043a\u0440\u0430\u0458 \u043a\u043e\u043d\u0442\u0440\u043e\u043b\u0430 \u043b\u0435\u0432\u0438 \u0440\u0435\u043a\u0435\u0442 \u043f\u043e\u0441\u0442\u0430\u0458\u0435 \u0430\u0433\u0435\u043d\u0442.',
        r1_mode_human: '\u041b\u0435\u0432\u043e: \u0447\u043e\u0432\u0435\u043a',
        r1_mode_agent: '\u041b\u0435\u0432\u043e: \u0430\u0433\u0435\u043d\u0442',
        x_box_title: '\u0417\u0440\u0430\u043a',
        x_ray_on: '\u0417\u0440\u0430\u043a: \u0443\u043a\u0459\u0443\u0447\u0435\u043d',
        x_ray_off: '\u0417\u0440\u0430\u043a: \u0438\u0441\u043a\u0459\u0443\u0447\u0435\u043d',
        x_heat_on: 'Heatmap: укључен',
        x_heat_off: 'Heatmap: искључен',
