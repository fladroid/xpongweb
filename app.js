...
(function () {
  ...
  var T = {
    en: {
      ...
      r2_page_title: 'This page — RL 2',
      r2_nav_text: 'The left paddle is the learning agent; the right one is the random walker from the previous page, unchanged. Train runs episodes in the background and, every 500 episodes, plays one evaluation match live on the court so you can watch what the numbers mean. Reset clears the whole training session — the table, the curves, and the court.',
      r2_page_text: 'The second RL page, and the first with an agent that <strong>learns</strong>. The subject here is not learning itself but what the agent can <em>see</em>: the world reduced to a finite set of bins. The grid draws two of the five dimensions — where the ball is. Direction, speed and the paddle’s own position also enter the state number but have no place on the court. Press Train, then change the grid and train again: every run adds a curve, and the spread between runs is the reliability, not the height alone. The learning rule itself arrives on the next page.',
    ...
    de: {
      ...
      r2_page_title: 'Diese Seite \u2014 RL 2',
      r2_nav_text: 'Der linke Schläger ist der lernende Agent; der rechte bleibt der Random Walker der vorigen Seite, unverändert. Train läuft im Hintergrund und spielt alle 500 Episoden eine Bewertungspartie live auf dem Feld, damit sichtbar wird, was die Zahlen bedeuten. Reset löscht die gesamte Trainingssitzung — Tabelle, Kurven und Feld.',
      r2_page_text: 'Die zweite RL-Seite und die erste mit einem Agenten, der <strong>lernt</strong>. Das Thema ist nicht das Lernen selbst, sondern was der Agent <em>sieht</em>: die Welt, reduziert auf endlich viele F\u00e4cher. Das Raster zeichnet zwei der f\u00fcnf Dimensionen \u2014 wo der Ball ist. Richtung, Geschwindigkeit und die eigene Schl\u00e4gerposition gehen ebenfalls in die Zustandszahl ein, haben aber keinen Ort auf dem Feld. Train dr\u00fccken, dann das Raster wechseln und erneut trainieren: jeder Lauf f\u00fcgt eine Kurve hinzu, und die Streuung zwischen den L\u00e4ufen ist die Verl\u00e4sslichkeit, nicht die H\u00f6he allein. Die Lernregel selbst folgt auf der n\u00e4chsten Seite.',
    ...
    it: {
      ...
      r2_page_title: 'Questa pagina \u2014 RL 2',
      r2_nav_text: 'La racchetta sinistra è l’agente che impara; quella destra resta il random walker della pagina precedente, invariato. Train gira in background e, ogni 500 episodi, gioca dal vivo una partita di valutazione sul campo, così si vede cosa significano i numeri. Reset azzera l’intera sessione di addestramento — tabella, curve e campo.',
      r2_page_text: 'La seconda pagina RL, e la prima con un agente che <strong>impara</strong>. Il tema non \u00e8 l\u2019apprendimento in s\u00e9 ma ci\u00f2 che l\u2019agente <em>vede</em>: il mondo ridotto a un numero finito di caselle. La griglia disegna due delle cinque dimensioni \u2014 dove si trova la palla. Direzione, velocit\u00e0 e la posizione della racchetta entrano anch\u2019esse nel numero di stato ma non hanno posto sul campo. Premi Train, poi cambia griglia e allena di nuovo: ogni esecuzione aggiunge una curva, e la dispersione fra le esecuzioni \u00e8 l\u2019affidabilit\u00e0, non l\u2019altezza da sola. La regola di apprendimento arriva nella pagina successiva.',
    ...
    hr: {
      ...
      r2_page_title: 'Ova stranica \u2014 RL 2',
      r2_nav_text: 'Lijevi reket je agent koji uči; desni ostaje nasumični šetač s prethodne stranice, nepromijenjen. Train radi u pozadini i svakih 500 epizoda odigra jednu evaluacijsku partiju uživo na terenu, da se vidi što brojevi znače. Reset briše cijelu sesiju treninga — tabelu, krivulje i teren.',
      r2_page_text: 'Druga RL stranica i prva s agentom koji <strong>u\u010di</strong>. Tema nije samo u\u010denje nego ono \u0161to agent <em>vidi</em>: svijet sveden na kona\u010dan broj pregrada. Mre\u017ea crta dvije od pet dimenzija \u2014 gdje je loptica. Smjer, brzina i polo\u017eaj vlastitog reketa tako\u0111er ulaze u broj stanja, ali nemaju mjesto na terenu. Pritisni Train, pa promijeni mre\u017eu i treniraj ponovo: svako pokretanje dodaje krivulju, a raspr\u0161enost me\u0111u pokretanjima jest pouzdanost, ne sama visina. Samo pravilo u\u010denja dolazi na sljede\u0107oj stranici.',
    ...
    sr: {
      cyr: {
        ...
        r2_page_title: '\u041e\u0432\u0430 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u2014 \u0420\u041b 2',
        r2_nav_text: 'Леви рекет је агент који учи; десни остаје насумични шетач с претходне странице, непромењен. Train ради у позадини и сваких 500 епизода одигра једну евалуациону партију уживо на терену, да се види шта бројеви значе. Reset брише целу сесију тренинга — табелу, криве и терен.',
        r2_page_text: '\u0414\u0440\u0443\u0433\u0430 \u0420\u041b \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u0438 \u043f\u0440\u0432\u0430 \u0441 \u0430\u0433\u0435\u043d\u0442\u043e\u043c \u043a\u043e\u0458\u0438 <strong>\u0443\u0447\u0438</strong>. \u0422\u0435\u043c\u0430 \u043d\u0438\u0458\u0435 \u0441\u0430\u043c\u043e \u0443\u0447\u0435\u045a\u0435 \u043d\u0435\u0433\u043e \u043e\u043d\u043e \u0448\u0442\u043e \u0430\u0433\u0435\u043d\u0442 <em>\u0432\u0438\u0434\u0438</em>: \u0441\u0432\u0435\u0442 \u0441\u0432\u0435\u0434\u0435\u043d \u043d\u0430 \u043a\u043e\u043d\u0430\u0447\u0430\u043d \u0431\u0440\u043e\u0458 \u043f\u0440\u0435\u0433\u0440\u0430\u0434\u0430. \u041c\u0440\u0435\u0436\u0430 \u0446\u0440\u0442\u0430 \u0434\u0432\u0435 \u043e\u0434 \u043f\u0435\u0442 \u0434\u0438\u043c\u0435\u043d\u0437\u0438\u0458\u0430 \u2014 \u0433\u0434\u0435 \u0458\u0435 \u043b\u043e\u043f\u0442\u0438\u0446\u0430. \u0421\u043c\u0435\u0440, \u0431\u0440\u0437\u0438\u043d\u0430 \u0438 \u043f\u043e\u043b\u043e\u0436\u0430\u0458 \u0441\u043e\u043f\u0441\u0442\u0432\u0435\u043d\u043e\u0433 \u0440\u0435\u043a\u0435\u0442\u0430 \u0442\u0430\u043a\u043e\u0452\u0435 \u0443\u043b\u0430\u0437\u0435 \u0443 \u0431\u0440\u043e\u0458 \u0441\u0442\u0430\u045a\u0430, \u0430\u043b\u0438 \u043d\u0435\u043c\u0430\u0458\u0443 \u043c\u0435\u0441\u0442\u043e \u043d\u0430 \u0442\u0435\u0440\u0435\u043d\u0443. \u041f\u0440\u0438\u0442\u0438\u0441\u043d\u0438 Train, \u043f\u0430 \u043f\u0440\u043e\u043c\u0435\u043d\u0438 \u043c\u0440\u0435\u0436\u0443 \u0438 \u0442\u0440\u0435\u043d\u0438\u0440\u0430\u0458 \u043f\u043e\u043d\u043e\u0432\u043e: \u0441\u0432\u0430\u043a\u043e \u043f\u043e\u043a\u0440\u0435\u0442\u0430\u045a\u0435 \u0434\u043e\u0434\u0430\u0458\u0435 \u043a\u0440\u0438\u0432\u0443, \u0430 \u0440\u0430\u0441\u0435\u0458\u0430\u045a\u0435 \u043c\u0435\u0452\u0443 \u043f\u043e\u043a\u0440\u0435\u0442\u0430\u045a\u0438\u043c\u0430 \u0458\u0435\u0441\u0442\u0435 \u043f\u043e\u0443\u0437\u0434\u0430\u043d\u043e\u0441\u0442, \u043d\u0435 \u0441\u0430\u043c\u0430 \u0432\u0438\u0441\u0438\u043d\u0430. \u0421\u0430\u043c\u043e \u043f\u0440\u0430\u0432\u0438\u043b\u043e \u0443\u0447\u0435\u045a\u0430 \u0434\u043e\u043b\u0430\u0437\u0438 \u043d\u0430 \u0441\u043b\u0435\u0434\u0435\u045b\u043e\u0458 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0438.',
